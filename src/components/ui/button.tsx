...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-medium button-glow",
        destructive:
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-medium hover:shadow-glow button-glow font-semibold",
        accent: "bg-brand-blue text-white hover:bg-brand-blue/90 shadow-soft hover:shadow-medium button-glow",
        gradient: "bg-gradient-secondary text-white hover:scale-105 shadow-medium hover:shadow-glow button-glow",
      },
      size: {
